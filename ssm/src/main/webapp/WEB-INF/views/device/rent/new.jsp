                ...
                <div class="box-body">
                    <table class="table">
                       ...
                       <tr v-for="device in deviceArray">
                           ...
                           <td>{{device.total}}</td>
                           <td>
                               <a href="javascript:;" v-on:click="remove(device)"><i class="fa fa-trash text-danger"></i></a>
                           </td>
                       </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group">
                            ...
                            <label>设备名称</label>
                            <select id="deviceId" style="width: 400px;" class="form-control">
...
<script>
    ...
    $(function () {
        ...
        $("#backDate").datepicker({
            ...
            var days=backDay.diff(rentDay,'day')+1;
            $("#totalDays").val(days);
        });
